...
public class CategoryRequest {
    ...
    public void execute() {
        // SQL запрос для получения категорий, в которых количество товаров больше единицы
        ...
        // Выполняем запрос и мапим результат
    ...
    // Вспомогательный класс для хранения результата запроса
